...
z pamięci. Ścieżki bezwzględne są zneutralizowane do `/repo/...`, żeby
fixture nie zależał od katalogu, w którym została nagrana; reszta struktury
(poziomy, kody błędów, `message`) jest nietknięta.
"""
